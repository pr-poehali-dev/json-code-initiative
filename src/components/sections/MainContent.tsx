      ...
      <section className="relative w-full overflow-hidden">
        <div className="relative h-[600px] md:h-[700px] lg:h-[800px]">
          {slides.map((slide, index) => (
            ...
            >
              <div className="absolute inset-0 bg-[#1a2b5c] z-0"></div>
              <img
                src={slide.image}
                alt={slide.title}
                className="w-full h-full object-cover opacity-40"
              />
              <div className="absolute inset-0 bg-[#1a2b5c]/40 z-10"></div>
            ...
            {[
              ...
              >
                <div className="h-72 bg-white relative overflow-hidden">
                  ...
                  ) : item.title === 'Школьные фартуки' ? (
                    <div className="absolute inset-0 flex items-center justify-center">
                      <img 
                        src="https://cdn.poehali.dev/projects/c86e981a-6e6e-4e01-9814-a4779f1ba4d6/bucket/3616698e-2955-4d95-948b-841ca1371b77.jpg" 
                        alt="Школьный фартук"
                        className="w-full h-full object-cover group-hover:scale-105 transition-all duration-500"
                      />
                    </div>
            ...
            <div className="p-6">
              ...
              <div className="mt-12 pt-8 border-t border-gray-200">
                <div className="prose prose-lg max-w-none">
                  <h3 className="text-2xl font-bold text-[#151C45] mb-6">Школьные фартуки DeksKids — классика и комфорт</h3>
                  
                  <p className="text-gray-700 leading-relaxed mb-4">
                    Школьный фартук — важная часть классического школьного образа. В нём девочка выглядит аккуратно, нарядно и по‑особенному торжественно, а для родителей и педагогов это простой способ выдержать единый стиль класса. Бренд DeksKids разрабатывает и шьёт школьные фартуки с учётом современных требований к комфорту, износостойкости и внешнему виду.
                  </p>

                  <h4 className="text-xl font-bold text-[#151C45] mt-8 mb-4">Белые и чёрные школьные фартуки на 1 сентября и последний звонок</h4>
                  
                  <p className="text-gray-700 leading-relaxed mb-4">
                    В нашем каталоге представлены как нарядные белые фартуки для торжественных линеек и последнего звонка, так и более сдержанные чёрные модели для повседневной носки. Белый кружевной школьный фартук подчёркивает праздничность момента и красиво смотрится на фотографиях. Чёрный или тёмный фартук — практичное решение на каждый день: он меньше маркий и легко сочетается с классическими школьными платьями и сарафанами.
                  </p>

                  <p className="text-gray-700 leading-relaxed mb-4">
                    Мы предлагаем разные варианты кроя: с воланами и рюшами, с крылышками, с лаконичным силуэтом без лишнего декора. Это позволяет подобрать модель под устав школы, требования классного руководителя и вкусы самой школьницы.
                  </p>

                  <h4 className="text-xl font-bold text-[#151C45] mt-8 mb-4">Удобные фасоны и продуманные детали</h4>
                  
                  <p className="text-gray-700 leading-relaxed mb-4">
                    Все школьные фартуки DeksKids сконструированы так, чтобы ребёнку было удобно в течение всего учебного дня. Мы используем комфортные для кожи ткани, которые хорошо держат форму и не требуют сложного ухода. В зависимости от модели предусмотрены:
                  </p>

                  <ul className="list-disc list-inside text-gray-700 mb-4 space-y-2">
                    <li>регулировка по длине бретелей</li>
                    <li>завязки или застёжки, которые легко обслуживать</li>
                    <li>удобные по глубине карманы (в тех моделях, где это предусмотрено)</li>
                    <li>прочная фурнитура и аккуратная обработка швов</li>
                  </ul>

                  <p className="text-gray-700 leading-relaxed mb-4">
                    Фартуки выпускаются в популярных ростовках для начальной, средней и старшей школы, поэтому вы легко подберёте размер как для первоклассницы, так и для выпускницы.
                  </p>

                  <h4 className="text-xl font-bold text-[#151C45] mt-8 mb-4">Для родителей, школ и классов</h4>
                  
                  <p className="text-gray-700 leading-relaxed mb-4">
                    Мы работаем как с розничными покупателями, так и с организованными группами: классами, школами, студиями, творческими коллективами. При заказе школьных фартуков на класс или школу можно подобрать единый стиль: один фасон в разных размерах или несколько близких по дизайну моделей. Это удобно, если вы формируете дресс‑код для параллели или всего учебного заведения.
                  </p>

                  <p className="text-gray-700 leading-relaxed mb-4">
                    Как производитель школьной формы, DeksKids обеспечивает стабильное качество и повторяемость моделей от сезона к сезону. Это особенно актуально, когда нужно через год докупить фартуки для новых учеников или младших сестёр.
                  </p>

                  <h4 className="text-xl font-bold text-[#151C45] mt-8 mb-4">Почему стоит выбрать школьные фартуки DeksKids</h4>
                  
                  <ul className="list-disc list-inside text-gray-700 mb-6 space-y-2">
                    <li>собственное производство школьной формы и фартуков</li>
                    <li>аккуратная посадка по фигуре российских детей</li>
                    <li>ткани, рассчитанные на активную носку и частые стирки</li>
                    <li>актуальные фасоны, сочетающие классику и современные тренды</li>
                    <li>возможность заказа как одной вещи, так и комплекта на класс или школу</li>
                  </ul>

                  <p className="text-gray-700 leading-relaxed">
                    Выберите подходящий школьный фартук в каталоге, добавьте товар в корзину и оформите заказ онлайн. Если вам нужна консультация по размеру, фасону или подбору комплекта к школьному платью, свяжитесь с нами — команда DeksKids поможет собрать идеальный образ для школы.
                  </p>
                </div>
              </div>
            </div>
